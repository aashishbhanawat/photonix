...
class Command(BaseCommand):
    ...
    def create_library(self, username, library_name, path):
        ...
        print(
            f'Library "{library_name}" with path "{path}" created successfully for user "{username}"')
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--path', type=self.is_path_dir,
                            default='/data/photos')

    def handle(self, *args, **options):
        self.create_library(options['username'],
