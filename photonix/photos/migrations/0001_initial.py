    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(
                    help_text='Display name of the library', max_length=128)),
                ...
                ('setup_stage_completed', models.CharField(blank=True, choices=[('St', 'Storage backend configured'), ('Im', 'Photo importing configured'), (
                    'Th', 'Thumbnailing storage configured')], help_text='Where the user got to during onboarding setup', max_length=2, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('focal_length', models.DecimalField(
                    decimal_places=1, max_digits=4, null=True)),
                ...
                ('camera', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE,
                 related_name='photos', to='photos.Camera')),
                ('lens', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE,
                 related_name='photos', to='photos.Lens')),
                ('library', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='photos', to='photos.Library')),
            ],
            options={
                'ordering': ['-taken_at'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('L', 'Location'), ('O', 'Object'), ('F', 'Face'), (
                    'C', 'Color'), ('S', 'Style')], db_index=True, default='P', max_length=1)),
                ...
                ('parent', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE,
                 related_name='children', to='photos.Task')),
            ],
            options={
                'ordering': ['created_at'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(blank=True)),
                ('name', models.CharField(max_length=128)),
                ('type', models.CharField(choices=[('L', 'Location'), ('O', 'Object'), (
                    'F', 'Face'), ('C', 'Color'), ('S', 'Style')], max_length=1, null=True)),
                ('source', models.CharField(choices=[
                 ('H', 'Human'), ('C', 'Computer')], max_length=1)),
                ('library', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, related_name='tags', to='photos.Library')),
                ('parent', models.ForeignKey(
                    null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='photos.Tag')),
            ],
            options={
                'ordering': ['name'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='photo_tags', to='photos.Photo')),
                ('tag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='photo_tags', to='photos.Tag')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('raw_external_version', models.CharField(
                    blank=True, max_length=16, null=True)),
                ('photo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='files', to='photos.Photo')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(blank=True, db_index=True)),
                ('updated_at', models.DateTimeField(blank=True)),
                ('type', models.CharField(choices=[('St', 'Store'), ('Im', 'Import only'), (
                    'Th', 'Thumbnails')], help_text='What type of path this is', max_length=2)),
                ('backend_type', models.CharField(choices=[('Lo', 'Local filesystem'), (
                    'S3', 'S3-compatible block storage')], help_text='What type of storage to use for imported photos', max_length=2)),
                ('path', models.CharField(
                    help_text='Path for storing photos - local path or bucket name', max_length=128)),
                ('url', models.CharField(
                    blank=True, help_text='If a public-facing URL is available to access block storage, client will use this to download photos', max_length=128, null=True)),
                ('delete_after_import', models.BooleanField(default=False,
                 help_text='Remove the photo from import_path after import succeeded?')),
                ('watch_for_changes', models.BooleanField(default=False,
                 help_text='Watch import_path for local filesystem changes?')),
                ('s3_access_key_id', models.CharField(
                    blank=True, help_text='AWS S3 (or compatible) access key ID', max_length=20, null=True)),
                ('s3_secret_key', models.CharField(
                    blank=True, help_text='AWS S3 (or compatible) secret key', max_length=40, null=True)),
                ('library', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='paths', to='photos.Library')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name='lenses', to='photos.Library'),
        ),
        migrations.AddField(
            model_name='camera',
            name='library',
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name='cameras', to='photos.Library'),
        ),
        migrations.CreateModel(
            name='LibraryUser',
            fields=[
                ...
                ('owner', models.BooleanField(default=False,
                 help_text="This User is responsible for this Library's settings and maintenance")),
                ('library', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='users', to='photos.Library')),
